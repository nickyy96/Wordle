...
const Header = ({setModal, hard}: HeaderProps) => {
    const setPersonal = () => setModal('personal')
    const setInfo = () => setModal('info')
    const setSettings = () => setModal('settings')
    const setStats = () => setModal('stats')
    return (
        <header className='wordle-header'>
            <button className="header-menu-button" onClick={setPersonal}>
            ...
            <div className="wordle-header-text-container">
            ...
            <div className="menu-button-container">
                <button className="container-menu-button" onClick={setInfo}>
                ...
                <button className="container-menu-button" onClick={setStats}>
                ...
                <button className="container-menu-button" onClick={setSettings}>
